...
export function SelectedData() {
    const selectedCategiry = useAppSelector(state => state.tarot.selectedCategory)
    ...
    if(!selectedCategiry && !slectedSpread){
        return null;
    }
    ...
    return (
        <div className="flex gap-4 min-h-[48px]">
            {selectedCategiry && (
                ...
                >
                    <span className="text-black text-sm">{selectedCategiry}</span>
